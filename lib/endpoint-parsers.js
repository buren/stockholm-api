...
const singleCamelizeData = (object, fieldNames) => {
  const result = {}
...
const extractAndCamelizeData = (data, fieldNames) => {
  // TODO: Check browser support for isArray()
  if (Array.isArray(data)) {
    return data.map((object) => singleCamelizeData(object, fieldNames))
  }
  return singleCamelizeData(data, fieldNames)
}

const parseCount = (data) => {
  return extractAndCamelizeData[data, 'Value']
}
